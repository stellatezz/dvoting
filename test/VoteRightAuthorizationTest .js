...
contract("Vote Right Authorization Test", function (accounts) {
    ...
    it("should not allow unregistered votes", async function () {
      ...
      await expectRevert(this.GoodVoting.vote([0, 1], { from: voter3 }), "NV");
    ...
    it("should not allow non admin register voter", async function () {
      await expectRevert(
        this.GoodVoting.registerVoter(voter1, { from: voter1 }),
        "NA"
      );

      await expectRevert(
        this.GoodVoting.registerVoter(voter1, { from: voter2 }),
        "NA"
      );
